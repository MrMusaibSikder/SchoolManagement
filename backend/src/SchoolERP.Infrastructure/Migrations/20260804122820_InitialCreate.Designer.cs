...
namespace SchoolERP.Infrastructure.Migrations
{
    ...
    [Migration("20260804122820_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.ExamResult", b =>
                {
                    ...
                    b.Property<string>("GuardianRemarks")
                        .HasMaxLength(500)
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.FeeStructure", b =>
                {
                    ...
                    b.HasIndex("SchoolClassId", "SectionId", "AcademicYearId")
                        .IsUnique()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.FeeStructureItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.GradeSetup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AcademicYearId", "GradeName")
                        .IsUnique();

                    b.ToTable("GradeSetups", null, t =>
                        {
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.HasIndex("StudentId", "AcademicYearId", "Month", "Year", "FeeStructureId")
                        .IsUnique()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.LateFineRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Receipt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.ResultAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.StudentFeeConcession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentId", "FeeTypeId", "AcademicYearId")
                        .IsUnique()
                        .HasDatabaseName("IX_StudentFeeConcessions_Student_FeeType_AcademicYear");

                    b.ToTable("StudentFeeConcessions", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.FeeStructure", b =>
                {
                    ...
                    b.HasOne("SchoolERP.Domain.Entities.FeeStructure", "ClonedFrom")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.HasOne("SchoolERP.Domain.Entities.Employee", "CancelledByEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Payment", b =>
                {
                    b.HasOne("SchoolERP.Domain.Entities.Employee", "CollectedByEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.Receipt", b =>
                {
                    b.HasOne("SchoolERP.Domain.Entities.Employee", "IssuedByEmployee")
                        .WithMany()
                        .HasForeignKey("IssuedByEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SchoolERP.Domain.Entities.Payment", "Payment")
                        .WithOne("Receipt")
                        .HasForeignKey("SchoolERP.Domain.Entities.Receipt", "PaymentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.StudentFeeConcession", b =>
                {
                    b.HasOne("SchoolERP.Domain.Entities.AcademicYear", "AcademicYear")
                        .WithMany("StudentFeeConcessions")
                        .HasForeignKey("AcademicYearId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SchoolERP.Domain.Entities.Employee", "ApprovedByEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.AcademicYear", b =>
                {
                    ...
                    b.Navigation("LateFineRules");

                    b.Navigation("StudentFeeConcessions");
                });
